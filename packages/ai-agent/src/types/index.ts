...
export const MatchCandidatesOutputSchema = z.object({
  matches: z.array(z.object({
    ...
    studyStyle: z.string().nullish().describe('Their study style'),
    skillLevel: z.string().nullish().describe('Their skill level'),
    school: z.string().nullish().describe('Their school/institution'),
