    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 relative">
      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Start your free trial</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          ...
          <form onSubmit={handleEmailSignup} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 text-white rounded-md px-4 py-2.5 text-sm font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
