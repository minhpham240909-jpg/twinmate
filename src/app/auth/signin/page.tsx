...
export default function SignInPage() {
  return (
    <div className="min-h-screen bg-white relative flex items-center justify-center p-4 overflow-hidden">
      ...
      {/* Decorative elements */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-blue-100/40 to-blue-100/40 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" />
