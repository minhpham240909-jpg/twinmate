...
export default function HomePage() {
      ...
      const observer = new IntersectionObserver(
        ([entry]) => {
          if (entry.isIntersecting) {
            setIsVisible(prev => ({ ...prev, [`item-${index}`]: true }))
            observer.disconnect()
          }
        },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-blue-50/30 to-white">
      ...
      {/* Hero Section with Modern CSS Background */}
      <section className="relative pt-32 pb-48 overflow-hidden" style={{ contain: 'layout style paint' }}>
        {/* Modern CSS Background - Replaces DarkVeil */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl text-white/90 mb-12 font-light max-w-3xl mx-auto leading-relaxed"
            >
            ...
            >
              ...
              <Link
                href="#how-it-works"
                className="px-10 py-5 text-white text-lg font-medium rounded-full border-2 border-white/30 hover:bg-white/10 hover:scale-105 transition-all duration-300 backdrop-blur-sm"
              >
                Learn More
              </Link>
            </motion.div>
          ...
          <div className="mt-24 relative h-64">
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className={`absolute w-32 h-32 rounded-2xl bg-gradient-to-br backdrop-blur-sm animate-float-${i}`}
                style={{
                  left: `${20 + i * 25}%`,
                  top: `${Math.sin(i) * 30}%`,
                  background: i % 3 === 0
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            {[
              ...
              >
                ...
                >
                  <div className="bg-gradient-to-br from-white to-slate-50 rounded-3xl p-10 h-full">
                    {/* Step Number Badge */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <GlowBorder color="#3b82f6" intensity="medium" animated={false} style={{ borderRadius: 24 }}>
                <div className="bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-700 rounded-3xl p-12 relative overflow-hidden">
                  {/* Simplified CSS background pattern */}
                  <div className="absolute inset-0 opacity-10">
                    {[...Array(8)].map((_, i) => (
                      <div
                        key={i}
                        className="absolute w-1 h-8 bg-white rounded-full animate-slide-up"
                        style={{
                          left: `${i * 12}%`,
                          bottom: 0,
                ...
                <div className="bg-gradient-to-br from-pink-500 via-purple-600 to-indigo-700 rounded-3xl p-8 relative overflow-hidden">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="aspect-square bg-white/10 backdrop-blur-md rounded-xl border-2 border-white/30 flex items-center justify-center relative overflow-hidden animate-pulse-slow"
                        style={{
                          animationDelay: `${i * 0.5}s`,
                        }}
                      >
      ...
      <section id="features" className="py-32 bg-gradient-to-b from-white to-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-32 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 relative overflow-hidden">
        {/* CSS Dot Pattern Background - Replaces WebGLDotGrid */}
        <div className="absolute inset-0 opacity-10">
          <ModernDotPattern dotSize={2} gap={30} color="rgba(255,255,255,0.3)" />
        </div>
