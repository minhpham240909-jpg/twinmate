  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white dark:bg-slate-800/40 backdrop-blur-xl border border-gray-200 dark:border-slate-700/50 rounded-lg shadow-lg dark:shadow-xl p-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-100 mb-8">Privacy Policy</h1>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-4">1. Introduction</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-4">2. Information We Collect</h2>

            <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-200 mb-3">2.1 Information You Provide</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-200 mb-3">2.2 Automatically Collected Information</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-slate-300 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-200 mb-3">2.3 Communication Data</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-slate-300 mb-4 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-4">3. How We Use Your Information</h2>
            <p className="text-gray-700 dark:text-slate-300 mb-4">We use your information to:</p>
            <ul className="list-disc pl-6 text-gray-700 dark:text-slate-300 mb-4 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-4">4. Information Sharing</h2>

            <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-200 mb-3">4.1 With Other Users</h3>
            <p className="text-gray-700 dark:text-slate-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-200 mb-3">4.2 Service Providers</h3>
            <p className="text-gray-700 dark:text-slate-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-200 mb-3">4.3 Legal Requirements</h3>
            <p className="text-gray-700 dark:text-slate-300 mb-4">
              We may disclose information if required by law or to protect our rights, safety, or the rights and safety of others.
            </p>

            <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-200 mb-3">4.4 We Do NOT Sell Your Data</h3>
            <p className="text-gray-700 dark:text-slate-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-4">5. Data Security</h2>
            <p className="text-gray-700 dark:text-slate-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-4">6. Your Privacy Rights</h2>
            <p className="text-gray-700 dark:text-slate-300 mb-4">You have the right to:</p>
            <ul className="list-disc pl-6 text-gray-700 dark:text-slate-300 mb-4 space-y-2">
            ...
            <p className="text-gray-700 dark:text-slate-300 mb-4">
              ...
              <a href="mailto:privacy@clerva.com" className="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 underline">
                privacy@clerva.com
              </a>
            </p>
          </section>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-4">7. Data Retention</h2>
            <p className="text-gray-700 dark:text-slate-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-4">8. Cookies and Tracking</h2>
            <p className="text-gray-700 dark:text-slate-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-4">9. Children's Privacy</h2>
            <p className="text-gray-700 dark:text-slate-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-4">10. International Users</h2>
            <p className="text-gray-700 dark:text-slate-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-4">11. Changes to Privacy Policy</h2>
            <p className="text-gray-700 dark:text-slate-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-slate-100 mb-4">12. Contact Us</h2>
            <p className="text-gray-700 dark:text-slate-300 mb-4">
              If you have questions about this Privacy Policy or your data:
            </p>
            <p className="text-gray-700 dark:text-slate-300 mb-2">
              Email: <a href="mailto:privacy@clerva.com" className="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 underline">privacy@clerva.com</a>
            </p>
            <p className="text-gray-700 dark:text-slate-300">
              Support: <a href="mailto:support@clerva.com" className="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 underline">support@clerva.com</a>
            </p>
          </section>

          <section className="mb-8 p-4 bg-gray-50 dark:bg-slate-700/30 rounded-lg border border-gray-200 dark:border-slate-600/50">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-200 mb-2">Your Privacy Matters</h3>
