      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-8">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">3.2 Email Verification</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">5.2 Content Moderation</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">5.3 Copyright</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Your use of the Service is also governed by our <a href="/privacy" className="text-blue-600 hover:text-blue-800 underline">Privacy Policy</a>, which explains how we collect, use, and protect your information.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Study Sessions & Video Calls</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">8.2 Educational Content</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">8.3 User Interactions</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              Email: <a href="mailto:support@clerva.com" className="text-blue-600 hover:text-blue-800 underline">support@clerva.com</a>
            </p>
          </section>
