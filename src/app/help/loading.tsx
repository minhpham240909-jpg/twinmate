/**
 * Help Loading State
 * Displays a skeleton UI while the help page is loading
 */
      ...
      <main className="max-w-2xl mx-auto px-4 py-6 space-y-6 pb-24">
        ...
        <div className="grid grid-cols-2 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 p-4 h-24"
            >
              <div className="h-8 w-8 bg-neutral-200 dark:bg-neutral-800 rounded-lg animate-pulse mb-2" />
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 p-6">
          ...
          <div className="space-y-3">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="py-3 border-b border-neutral-100 dark:border-neutral-800 last:border-0">
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 p-6">
          ...
          <div className="h-4 w-full bg-neutral-200 dark:bg-neutral-800 rounded animate-pulse mb-4" />
